...
export const metadata: Metadata = {
  title: "Luxe Hotel - 5-Star Luxury Accommodations",
  description: "Experience exceptional hospitality at Luxe Hotel. Premium rooms, world-class amenities, fine dining, and personalized service in the heart of the city.",
  keywords: "luxury hotel, 5-star accommodation, premium suites, hotel amenities, fine dining, spa, business travel, luxury travel",
  metadataBase: new URL("https://luxehotel.com"),
  alternates: {
    canonical: "https://luxehotel.com"
  },
  openGraph: {
    title: "Luxe Hotel - Exceptional Hospitality Awaits",
    ...
    images: [{
      ...
      alt: "Luxurious hotel lobby with modern design"
    }]
  },
  twitter: {
    card: "summary_large_image",
    title: "Luxe Hotel - 5-Star Luxury Accommodations",
    description: "Experience exceptional hospitality at Luxe Hotel with premium rooms and world-class amenities",
